...
\begin{document}
   ...
   Grouping the number of correct diagnoses by cluster size, shown in Table~\ref{tab:by_cluster},
   shows that having two clusters produced the most accurate predictor.

   TODO: Tukey's test and all that - make sure they are statistically distinct.
         Don't do regression because of the way clusters work and explain why it wasn't done.
